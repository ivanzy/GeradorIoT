...
public class StartSenSE {
	...
	public static void main(String[] args) {
		...
		if (Param.number_of_devices > 0 || Param.lambda > 0) {
			System.out.println("Starting experiment with: " + Param.number_of_devices + " sensors, " + Param.lambda
					+ " lambda," + Param.number_of_replications + " replications," + Param.address + " address,"
					+ Param.topic + " topic");
